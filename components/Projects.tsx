...
export default function Projects() {
  const projects = [
    {
      name: "LinkLeap",
      description: "A web application to automate daily tasks, such as detecting file additions in Google Drive and creating workflows for automated actions.",
    ...
    {
      name: "PDFInsight",
      description: "A web app to chat with your PDFs. Allows users to upload PDF documents, interact with their content, and ask questions about the PDF.",
      technologies: ["Next.js 14", "React", "Node.js", "TypeScript", "MySQL"],
        ...
        {projects.map((project, index) => (
          ...
          >
            ...
            <div className="flex space-x-4">
              <a href={project.github} target="_blank" rel="noopener noreferrer" className="flex items-center text-sm text-primary hover:underline">
